...
task(
  "token-transfer",
  "Transfers small amount of tokens from owner and backwards"
)
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    await cryptonToken.transfer(alice.address, parseUnits(taskArgs.amount));
    ...
    await cryptonToken
      .connect(alice)
      .transfer(owner.address, parseUnits(taskArgs.amount));
